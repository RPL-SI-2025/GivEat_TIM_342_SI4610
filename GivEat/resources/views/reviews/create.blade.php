...
<div class="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow" style="font-family: 'Poppins', sans-serif;">
    <h2 class="text-2xl font-bold mb-6">Tambah Ulasan Baru</h2>
    ...
    <form action="{{ route('reviews.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="flex justify-end">
            <button type="submit" class="bg-green-500 text-white px-6 py-2 rounded hover:bg-green-600">Kirim Ulasan</button>
        </div>
    </form>
</div>
