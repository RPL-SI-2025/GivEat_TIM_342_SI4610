...
@section('content')
<div class="container mx-auto px-4 flex justify-between items-center" style="font-family: 'Poppins', sans-serif;">
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        @endif
            <div class="p-4">
                ...
                {{-- Jika mau ada tombol baca detail, tinggal tambah disini --}}
                {{-- <a href="{{ route('reviews.show', $review) }}" class="block text-red-500 text-sm mt-4 font-bold hover:underline" style="font-family: 'Poppins', sans-serif;">Baca Semua Ulasan</a> --}}
            </div>
        </div>
        @empty
