<x-app-layout>
    <div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 mb-0" style="font-size: 1.5rem;">Daftar Donasi</h1>
                <p class="text-muted mb-0" style="font-size: 0.875rem; color: #6c757d;">Kelola data donasi makanan Anda</p>
            </div>
            <a href="{{ route('donations.create') }}" class="btn btn-primary rounded-pill px-4" style="font-weight: 500; background-color: #2cbb5c; border-color: #27ac5f; padding: 0.5rem 1.25rem;">
