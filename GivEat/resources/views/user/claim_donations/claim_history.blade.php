                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            @if ($claimHistory->hasMorePages())
                                <a href="{{ $claimHistory->nextPageUrl() }}" class="px-4 py-2 rounded-lg border border-[#006837] bg-white text-sm font-medium text-[#006837] hover:bg-gray-50 hover:border-[#00552e] hover:text-[#00552e] transition-colors duration-200 flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
