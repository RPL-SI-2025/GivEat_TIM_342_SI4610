                    ...
                    <div class="row g-4">
                        <div class="col-md-4">
                            <div class="card h-100">
                                <img src="{{ asset('images/nasi-liwet.jpg') }}" class="card-img-top" alt="Nasi Liwet" style="height: 200px; object-fit: cover;">
                                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="card h-100">
                                <img src="{{ asset('images/ayam-goreng.jpg') }}" class="card-img-top" alt="Ayam Goreng" style="height: 200px; object-fit: cover;">
                                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="card h-100">
                                <img src="{{ asset('images/kwetiau-goreng.jpg') }}" class="card-img-top" alt="Kwetiau Goreng" style="height: 200px; object-fit: cover;">
                                <div class="card-body">
